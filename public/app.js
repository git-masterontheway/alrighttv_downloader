...
// Automatically uses relative URL when hosted unified on Render, or connects to external production backend URL
const BACKEND_URL = window.ALRIGHT_BACKEND_URL || localStorage.getItem('ALRIGHT_BACKEND_URL') || '';
